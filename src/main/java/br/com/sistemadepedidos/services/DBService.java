...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cidade c3 = new Cidade(null, "Bombinhas", est2);
		...
		Cliente cli1 = new Cliente(null, "Grazziano", "springaula@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "springusuario@outlook.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
